...
var me = {firstname:"Anthony",age:36,state:"Texas"};
...
message["text"] = "I got this";

// #4 Create an object called 'adjustCount' and create two methods. One called 'upVote' and one called 'downVote'. upVote should take in a number and add one to it and downVote should take in a number and minus one from it.

var adjustCount = {
  upVote: function(num1){return (num1 = num1 +1)},
  downVote: function(num2){return (num2 = num2 - 1)}
}

// #5 Create an array called 'myFriends' with four of your friends names

var myFriends = ["Raul","Joseph","Jeremy","Glenn"];
...
function evensOnly(){
  ...
  myNumbers.forEach(function(num){
    if(num%2 == 0){evensArray.push(num)}
  }); return evensArray
}
...
var trueFriends = peopleIknow.filter(function(item){
  if (item.friend == true){return item.name};
})
...
function indexFinder(arr){
  var newarr = [];
  for(i=0;i<arr.length;i++){newarr.push(i)}
  return newarr;
}
